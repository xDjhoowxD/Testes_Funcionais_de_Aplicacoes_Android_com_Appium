...
public class FormularioTeste extends BaseTest {
    ...
    public void devePreecherCampoTexto() throws MalformedURLException {
    	page.escreverNome("Jhonatan");
        assertEquals("Jhonatan", page.obterNome());
    }
    ...
    public void deveRealizarCadastro() throws MalformedURLException {
        ...
        Assert.assertEquals("Nome: Jhonatan", page.obterNomeCadastrado());
...
//        esperar(3000);
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Nome: Jhonatan']")));
